...
const returnNames = (arr) => {
  // Solution code here...
  let starWarsNames = arr.reduce((names, list) => {
...
const reversedString = (str) => {
  // Solution code here...
  let reverse = [...str].reduce((revLetter, letters) => {
    return letters + revLetter;
  }, '');
  return reverse;
};
